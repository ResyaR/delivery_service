...
export class AddZoneToOngkirTables1700000000002 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Add zone column to ongkir_cities
    ...
    // Add rate_per_km to ongkir_services (tarif per km untuk jarak dalam zona)
    await queryRunner.addColumn(
      'ongkir_services',
      new TableColumn({
        name: 'rate_per_km',
    ...
    // Insert realistic zone tariffs (based on JNE pricing)
    // Service IDs: 1=Reguler, 2=Express, 5=Ekonomis
    await queryRunner.query(`
